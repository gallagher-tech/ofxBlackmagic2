...
meta:
	...
	ADDON_DESCRIPTION 	= Addon to wrap Blackmagic Decklink API for openFrameworks
	ADDON_AUTHOR 		= Elliot Woods (Gallagher & Associates fork by Tyler Henry)
	ADDON_TAGS 			= "device","camera","capture"
	ADDON_URL 			= https://github.com/gallagher-tech/ofxBlackmagic2
...
common:
	...
	# a specific platform
	# ADDON_LIBS_EXCLUDE = 
	# ADDON_SOURCES_EXCLUDE += src/ofxBlackMagic/vs/% src/ofxBlackMagic/osx/%
